...
fn empty_c2() -> TestResult {
    run(&[EMPTY, "-b", "2"], "tests/expected/empty.txt.c2.out")
}

// --------------------------------------------------
#[test]
fn empty_c4() -> TestResult {
    run(&[EMPTY, "-b", "4"], "tests/expected/empty.txt.c4.out")
}
...
fn one_c1() -> TestResult {
    run(&[ONE, "-b", "1"], "tests/expected/one.txt.c1.out")
}

#[test]
fn one_c2() -> TestResult {
    run(&[ONE, "-b", "2"], "tests/expected/one.txt.c2.out")
}

#[test]
fn one_c4() -> TestResult {
    run(&[ONE, "-b", "4"], "tests/expected/one.txt.c4.out")
}
...
fn one_c1_stdin() -> TestResult {
    run_stdin(&["-b", "1"], ONE, "tests/expected/one.txt.c1.out")
}

#[test]
fn one_c2_stdin() -> TestResult {
    run_stdin(&["-b", "2"], ONE, "tests/expected/one.txt.c2.out")
}

#[test]
fn one_c4_stdin() -> TestResult {
    run_stdin(&["-b", "4"], ONE, "tests/expected/one.txt.c4.out")
}
...
fn two_c2() -> TestResult {
    run(&[TWO, "-b", "2"], "tests/expected/two.txt.c2.out")
}

#[test]
fn two_c4() -> TestResult {
    run(&[TWO, "-b", "4"], "tests/expected/two.txt.c4.out")
}
...
fn two_c2_stdin() -> TestResult {
    run_stdin(&["-b", "2"], TWO, "tests/expected/two.txt.c2.out")
}

#[test]
fn two_c4_stdin() -> TestResult {
    run_stdin(&["-b", "4"], TWO, "tests/expected/two.txt.c4.out")
}
...
fn three_c2() -> TestResult {
    run(&[THREE, "-b", "2"], "tests/expected/three.txt.c2.out")
}

#[test]
fn three_c4() -> TestResult {
    run(&[THREE, "-b", "4"], "tests/expected/three.txt.c4.out")
}
...
fn three_c2_stdin() -> TestResult {
    run_stdin(&["-b", "2"], THREE, "tests/expected/three.txt.c2.out")
}

#[test]
fn three_c4_stdin() -> TestResult {
    run_stdin(&["-b", "4"], THREE, "tests/expected/three.txt.c4.out")
}
...
fn ten_c2() -> TestResult {
    run(&[TEN, "-b", "2"], "tests/expected/ten.txt.c2.out")
}

#[test]
fn ten_c4() -> TestResult {
    run(&[TEN, "-b", "4"], "tests/expected/ten.txt.c4.out")
}
...
fn ten_c2_stdin() -> TestResult {
    run_stdin(&["-b", "2"], TEN, "tests/expected/ten.txt.c2.out")
}

#[test]
fn ten_c4_stdin() -> TestResult {
    run_stdin(&["-b", "4"], TEN, "tests/expected/ten.txt.c4.out")
}
